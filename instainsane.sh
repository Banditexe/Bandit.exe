...
printf "\n"
printf "\e[1;77m\e[41m  Instagram Brute Forcer v1.0, Autor: Mario Serna Leon (Github/IG)  \e[0m\n" #Don't change, noob
printf "\n"
}


function start() {
read -p $'\e[1;92mNombre de usuario: \e[0m' user
...
read -p $'\e[1;92mPulsa Enter para iniciar el ataque: \e[0m' wl_pass
